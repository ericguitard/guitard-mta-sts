...
The official [Guitard Inc. Security Policy](https://guitard.ca/security-policy/)
applies to this repository and `mta-sts.guitard.ca`.
...
or unavailable policy responses through the same private process.
